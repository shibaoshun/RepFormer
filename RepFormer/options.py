...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='RepFormer', help='archtechture')
        parser.add_argument('--mode', type=str, default='derain', help='image restoration mode')
        ...
        parser.add_argument('--train_dir', type=str, default='./DATA/train', help='dir of train data')
        parser.add_argument('--val_dir', type=str, default='./DATA/test', help='dir of train data')
        parser.add_argument('--warmup', action='store_true', default=True, help='warmup')
        parser.add_argument('--warmup_epochs', type=int, default=3, help='epochs for warmup')
        parser.add_argument('--aug_times', type=int, default=8, help='times for data augments')
        return parser
