...
class MixUp_AUG:
    ...
    def aug(self, rgb_gt, rgb_noisy, gray_mask,gray_mask1):
        bs = rgb_gt.size(0)
        indices = torch.randperm(bs)
        rgb_gt2 = rgb_gt[indices]
        rgb_noisy2 = rgb_noisy[indices]
        gray_mask2 = gray_mask[indices]
        gray_mask3 = gray_mask1[indices]
        ...
        gray_mask1 = lam * gray_mask1 + (1-lam) * gray_mask3
        ...
        return rgb_gt, rgb_noisy, gray_mask,gray_mask1
