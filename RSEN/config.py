...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.DIM = 128
        self._C.TRAINING.HEAD_DIM = 64
        self._C.TRAINING.BIAS = False


        self._C.input_dir = './Datasets/test'
        self._C.result_dir = './results/SDNet/'
        self._C.weights = './pretrained_models/model_best.pth'
